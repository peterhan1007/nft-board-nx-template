import svg from '../assets/svg/footer-logo.svg';
import './style.css';
  ...
  return (
    <div className="bg-[#17161A] px-40 pt-[60px] pb-[40px]">
      <div className="flex flex-wrap justify-between">
        ...
        <div className="w-[40%] font-Inter">
          <h4 className="font-bold text-xl leading-8 text-white">NAVIGATION</h4>
          <div className="flex flex-row font-medium text-base leading-6 mt-[40px] text-white">
          ...
          <div className="mt-[72px] text-white font-Inter">
            <h4 className="font-bold text-xl leading-8 mb-[32px]">
              SUBSCRIBE TO RECEIVE OUR LATEST UPDATE
            </h4>
            <form action="#" className="flex flex-col md:flex-row gap-5">
              <input
                type="text"
                className="rounded border-white border-[1px] bg-[#17161A] focus-visible:border-white px-[20px] py-[12px] font-medium text-xs leading-5 w-[100%]"
        ...
        <div className="text-white font-Inter">
          <h4 className="font-bold text-xl leading-8">CONTACT US</h4>
      ...
      <div className="flex flex-row justify-between font-Inter text-white">
        <div>
          <span>©2022 GoSquid. All Rights reserved.</span>
        </div>
        <div className="flex flex-row font-medium text-base leading-6 gap-[60px]">
          <span>Security</span>
          <span>Legal</span>
          <span>Privacy</span>
        </div>
